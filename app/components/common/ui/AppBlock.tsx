...
const AppBlock = ({ post, isShowingDetails, showingStateChanged }: AppBlockProps) => {
    ...
    return (
        <>
            <Animated.View pointerEvents="none" style={[styles.blurViewWrapper, blurViewStyles]}>
                {Platform.OS !== 'android' ? (
                    <BlurView tint="dark" intensity={100} style={{ flex: 1 }} />
                ) : (
                    <View style={{ flex: 1, backgroundColor: '#fefefe', opacity: 0.9 }} />
                )}
            </Animated.View>
            ...
            <Animated.View style={[styles.container, containerZIndex]}>
                ...
                >
                    <AnimatedScrollView
                        style={[scrollViewStyles, { backgroundColor: '#fefefe' }]}
                        ...
                        onScroll={useAnimatedScrollHandler((event) => {
                            if (post.textStyle === 'dark')
                                closeBtnTint.value =
                                    ...
                                    THUMBNAIL_HEIGHT * THUMBNAIL_IMAGE_SCALE_FACTOR - 35
                                        ? 'light'
                                        : 'dark';
